...
namespace WebApi.Classes
{
    public class DataContext : DbContext
    {
        ...
        //private string _prodConString = @"Server=tcp:olimaserver.database.windows.net,1433;Initial Catalog=olima-v3;Persist Security Info=False;User ID=olimaadmin;Password='testadmin#01020305';MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
